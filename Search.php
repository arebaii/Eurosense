    ...
    if(isset($_POST['image_checker'])) {
        ...
        if($SearchImageResult != null) {
            ...
            <table>
                <thead>
                    <tr>
                        <th class="table_first"> N° DISK </th><th class="table_first"> Storage Location </th>
                        <th class="table_second"> RAW </th><th class="table_second"> LV0 </th><th class="table_second"> LV2 </th>
                        <th class="table_second"> LV3 </th><th class="table_second"> RVB </th><th class="table_second"> RVBI </th>
                        <th class="table_second"> PAN </th><th class="table_second"> CIR </th>
                    </tr>
                </thead>
                <tbody>
            <?php
            foreach($SearchImageResult as $IR) {
                echo "<tr class='AllLine' value='Line_" . $IR["id_"] . "'>";
            ...
            ?>
                ...
                <table>
                    <thead>
                        <tr>
                            <th class="table_first"> N° DISK </th><th class="table_first"> Storage Location </th>
                            <th class="table_second"> TIF </th><th class="table_second"> ECW </th><th class="table_second"> JPG </th>
                            <th class="table_second"> RGB </th><th class="table_second"> RGBI </th><th class="table_second"> NIR </th>
                            <th class="table_second"> 8BIT </th><th class="table_second"> 16BIT </th>
                        </tr>
                    </thead>
                    <tbody>
                <?php
            foreach($SearchOrthoResult as $OR) {
                echo "<tr class='AllLine' value='Line_" . $OR["id_"] . "'>";
        ...
        if($SearchLidarResult != null) {
            ...
            <table>
                <thead>
                    <tr>
                        <th class="table_first"> N° DISK </th><th class="table_first"> Storage Location </th>
                        <th class="table_second"> RAW </th><th class="table_second"> RGEO </th><th class="table_second"> RBlock </th>
                        <th class="table_second"> Adj </th><th class="table_second"> Adj&Fil </th><th class="table_second"> Deli </th>
                    </tr>
                </thead>
                <tbody>
            <?php
            foreach($SearchLidarResult as $LR) {
                echo "<tr class='AllLine' value='Line_" . $LR["id_"] . "'>";
        ...
        if($SearchProjectResult != null) {
            ...
            <table>
                <thead>
                    <tr>
                        <th class="table_first"> N° DISK </th><th class="table_first"> Storage Location </th>
                        <th class="table_second"> AOI </th><th class="table_second"> DGPS </th>
                        <th class="table_second"> AET </th><th class="table_second"> Tiling </th>
                    </tr>
                </thead>
                <tbody>
            <?php
            foreach($SearchProjectResult as $PR) {
                echo "<tr class='AllLine' value='Line_" . $PR["id_"] . "'>";
            ...
            <table>
                <thead>
                    <tr>
                        <th class="table_first"> N° DISK </th><th class="table_first"> Storage Location </th>
                        <th class="table_second"> RAW </th><th class="table_second"> LV0 </th><th class="table_second"> LV2 </th>
                        <th class="table_second"> LV3 </th><th class="table_second"> RGB </th><th class="table_second"> RGBI </th>
                        <th class="table_second"> PAN </th><th class="table_second"> CIR </th>
                    </tr>
                </thead>
                <tbody>
